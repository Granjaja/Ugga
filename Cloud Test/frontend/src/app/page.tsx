...
export default function Home() {
  ...
  return (
      <div className="flex items-center  flex-col max-w-4xl w-full m-auto min-h-screen p-3 border border-gray-300 rounded-md">
        <p className="mb-2 text-lg p-2">Intelligent assistant for our company knowledge.</p>
      ...
      <div className="text-gray-600 mb-4">
       ...
       <ul className="mt-2 flex flex-col md:flex-row justify-center gap-4 text-center">
